...
const About = () => (
  ...
  >
    ...
    <g id="Warstwa_2_kopia" data-name="Warstwa 2 kopia">
      <path
        className="neon-line"
        d="M45.55,16.74a11,11,0,1,1-20.49-5.66,11,11,0,0,1,20.49,5.66.63.63,0,0,0,1.25,0A12.27,12.27,0,1,0,24,23,12.28,12.28,0,0,0,46.8,16.74.63.63,0,0,0,45.55,16.74Z"
        form="late(-1.78 -1.34)"
      />
      <path
        className="neon-line"
        d="M6.32,64.91q-.12-6.54-.16-13.1a21.69,21.69,0,0,1,1.2-8.33A22.67,22.67,0,0,1,21.17,30.29c4.36-1.35,9-1.29,13.49-1.28a54.68,54.68,0,0,1,12,.92A19.6,19.6,0,0,1,56.83,35.5a24.65,24.65,0,0,1,4.33,6.71A21,21,0,0,1,62.89,51c0,4.65-.06,9.29-.08,13.94a.63.63,0,0,0,1.25,0q0-6.73.08-13.47a23.14,23.14,0,0,0-1-7.52C61,37.49,56.52,32,50.1,29.65a37.81,37.81,0,0,0-12.45-1.87,74.45,74.45,0,0,0-13.52.53A23.49,23.49,0,0,0,7.81,39.78a20.09,20.09,0,0,0-2.9,10.29c0,5,.07,9.9.16,14.84a.63.63,0,0,0,1.25,0Z"
        form="late(-1.78 -1.34)"
      />
      <path
        className="neon-line"
        d="M5.66,65.54H63.4a.63.63,0,0,0,0-1.25H5.66a.63.63,0,0,0,0,1.25Z"
        form="late(-1.78 -1.34)"
      />
      <path
        className="neon-line"
        d="M38.43,41.68c-1.76-1.68-4.79-1-6.85-.35-1,.32-4.75,1.48-4.22,3.12.32,1,2.07.72,2.83.89a2.54,2.54,0,0,1,2.16,2.53c.09,2.5-1.18,5-1.94,7.33-.55,1.67-1.42,4.28.2,5.65s4.57.49,6.36-.15a22.15,22.15,0,0,0,3.33-1.5,7.65,7.65,0,0,0,2.05-1.46c.52-.61.37-1.42-.51-1.51-1.26-.13-2.52.58-3.76,0s-1.1-2-.93-3.08a30.19,30.19,0,0,1,1.17-4.26c.65-2.11,1.87-5.28.11-7.18-.55-.59-1.43.29-.88.88,1.27,1.38.11,4.18-.35,5.68-.63,2-1.58,4.29-1.36,6.46.25,2.47,2.43,3.18,4.64,2.92a4.56,4.56,0,0,0,1.27-.15c.08-.09-.41-.57-.3-.59-.08,0-.26.25-.32.3a11.4,11.4,0,0,1-2.22,1.34c-1.86.93-4.19,1.94-6.33,1.76s-1.7-2.19-1.29-3.7c.62-2.23,1.62-4.34,2.09-6.61.39-1.9.37-4.13-1.46-5.29A5.06,5.06,0,0,0,29.81,44c-.31,0-.62-.06-.93-.09s-.46-.2-.41.13.35-.05.64-.25a8.65,8.65,0,0,1,1.38-.73A13.85,13.85,0,0,1,34.21,42c1.08-.15,2.49-.22,3.34.58C38.13,43.12,39,42.24,38.43,41.68Z"
        form="late(-1.78 -1.34)"
      />
      <path
        className="neon-line"
        d="M37.41,35.41a2.41,2.41,0,1,1-2-2.38,2.44,2.44,0,0,1,2,2.38.63.63,0,0,0,1.25,0A3.72,3.72,0,0,0,36.25,32a3.68,3.68,0,0,0-4,1.08A3.65,3.65,0,0,0,35.71,39a3.69,3.69,0,0,0,2.95-3.58A.63.63,0,0,0,37.41,35.41Z"
        form="late(-1.78 -1.34)"
      />
    </g>
  </svg>
...
const Contact = () => (
  ...
  >
    ...
    <g id="Warstwa_2_kopia" data-name="Warstwa 2 kopia">
      <path
        className="neon-line"
        d="M13.05,24.77a15.22,15.22,0,0,1,3.35-6,3.32,3.32,0,0,1,2.68-1.22c1.31.19,2.24,1.53,2.93,2.53,1.67,2.41,4,5.46,4.16,8.49a5.47,5.47,0,0,1-1,3.5,7.11,7.11,0,0,0-1.27,2.26c-.47,1.91.57,3.71,1.87,5a46.14,46.14,0,0,0,6.86,5.41C34.35,46,36.58,47.46,38.75,47c2-.46,2.48-2.28,3.3-3.89,1.06-2.06,2.51-.93,3.94,0a27.26,27.26,0,0,0,7,3.11,3.94,3.94,0,0,1,1.82.73c.81.89.07,2.5-.4,3.34a12.08,12.08,0,0,1-3.85,4.19c-4.2,2.75-9.83,2.87-14.55,1.65a31.54,31.54,0,0,1-11.53-6,37.73,37.73,0,0,1-8.28-8.5C13,36.68,11.26,30.45,13.05,24.77c.24-.77-1-1.1-1.21-.34C8.73,34.31,15,43.92,22.36,49.93a38.44,38.44,0,0,0,10.47,6.44c5.21,2,11.37,2.43,16.55.1A12.55,12.55,0,0,0,53,54.06c1.64-1.58,3.7-4.09,3.38-6.54-.22-1.71-1.58-2.15-3-2.57a32.26,32.26,0,0,1-7.76-3.67c-1.31-.79-2.78-1-3.92.22-1.53,1.64-1.41,4.94-4.54,4.19a11.58,11.58,0,0,1-3.77-2c-1.58-1.1-3.13-2.27-4.63-3.47-1.82-1.46-4.68-3.81-3.15-6.43a12.21,12.21,0,0,0,1.7-3.11,7.85,7.85,0,0,0-.31-4.57,25.8,25.8,0,0,0-2.52-4.65,19.44,19.44,0,0,0-2.86-3.94C17,13.25,13,20.89,11.84,24.43,11.59,25.2,12.8,25.53,13.05,24.77Z"
        form="late(-7.89 -9.7)"
      />
      <path
        className="neon-line"
        d="M42.51,34.43a12.33,12.33,0,0,0-9.93-8.35.64.64,0,0,0-.77.43.63.63,0,0,0,.43.77,11.14,11.14,0,0,1,9.06,7.48c.25.76,1.46.44,1.21-.33Z"
        form="late(-7.89 -9.7)"
      />
      <path
        className="neon-line"
        d="M50,33.55A17.71,17.71,0,0,0,31.21,19.18c-.79.06-.8,1.31,0,1.25a17,17,0,0,1,11,3.05,16.6,16.6,0,0,1,6.56,10.41c.15.79,1.36.45,1.21-.34Z"
        form="late(-7.89 -9.7)"
      />
      <path
        className="neon-line"
        d="M56.93,34.8A24,24,0,0,0,35.42,12.92a24.53,24.53,0,0,0-7,.36c-.78.16-.45,1.37.34,1.21a23,23,0,0,1,14.81,2A22.64,22.64,0,0,1,54.81,30.35a22.32,22.32,0,0,1,.87,4.45c.06.79,1.31.8,1.25,0Z"
        form="late(-7.89 -9.7)"
      />
      <path
        className="neon-line"
        d="M41.91,35.22a.63.63,0,0,0,0-1.25.63.63,0,0,0,0,1.25Z"
        form="late(-7.89 -9.7)"
      />
    </g>
  </svg>
...
const Projects = () => (
  <svg
    ...
    width="100%"
    height="100%"
    viewBox="-3 -3 79.36 76.96"
  >
    <g id="Warstwa_2_kopia" data-name="Warstwa 2 kopia">
      <path
        className="neon-blur"
        d="M55.35,63.68H14.68l3.75,3.75V4L14.68,7.72H55.35L51.6,4V67.43a3.75,3.75,0,0,0,7.5,0V4A3.8,3.8,0,0,0,55.35.22H14.68A3.8,3.8,0,0,0,10.93,4V67.43a3.8,3.8,0,0,0,3.75,3.75H55.35a3.75,3.75,0,0,0,0-7.5Z"
        form="late(2.17 -0.22)"
      />
      <path
        className="neon-blur"
        d="M57.06,9.91,66.48,12,63.86,7.35q-5,23-10,46a3.75,3.75,0,0,0,7.24,2q5-23,10-46a3.81,3.81,0,0,0-2.62-4.61L59.06,2.68a3.82,3.82,0,0,0-4.62,2.61,3.81,3.81,0,0,0,2.62,4.62Z"
        form="late(2.17 -0.22)"
      />
      <path
        className="neon-blur"
        d="M16.15,49.77Q10.66,29.5,5.19,9.24L2.57,13.85l10.73-3a3.81,3.81,0,0,0,2.62-4.61,3.8,3.8,0,0,0-4.61-2.62L.58,6.62A3.81,3.81,0,0,0-2,11.23l11,40.53a3.75,3.75,0,0,0,7.24-2Z"
        form="late(2.17 -0.22)"
      />
      <rect
        className="neon-blur"
      ...
      <path
        className="neon-blur"
        d="M48.28,31.25H23a5.2,5.2,0,0,0-.79,0s.25,0,.3.05a4.25,4.25,0,0,0,.39.25c.37.17-.18-.38,0,0,.1.2.26.7.3.62.14-.24,0-.94,0-1.22V15.57a14.74,14.74,0,0,0,0-2.82c.25.11-.62,1.05-.29.71s-.51.53-.71.29c0,0,.13,0,.15,0a5.34,5.34,0,0,0,1.13,0H46.7c.43,0,.88,0,1.3,0,0,0,.23,0,.26,0s.19.45-.14,0a4.65,4.65,0,0,0-.55-.28c-.29-.14.15.3,0,0-.33-.68-.3-.91-.3-.18V28.06a29.52,29.52,0,0,0,0,4s0,.19,0,.2c-.2-.13.34-.74.4-.83-.21.3-.4.14,0,0s.3-.17.6-.19a3.75,3.75,0,0,0,0,7.5,6.71,6.71,0,0,0,6.5-7V13.52c0-3.18-1.54-6.18-4.83-7a15.11,15.11,0,0,0-3.86-.22H32.76c-3.46,0-6.93-.07-10.4,0a6.65,6.65,0,0,0-6.67,6.57c0,1.33,0,2.68,0,4v13.6c0,2.25.08,4.33,1.69,6.16s3.74,2.15,6,2.15H48.28a3.75,3.75,0,0,0,0-7.5Z"
        form="late(2.17 -0.22)"
      />
      <text className="neon-blur" form="late(25.4 29.44)">
        R
        <tspan className="cls-4" x="11.36" y="0">
          G
        </tspan>
      </text>
      <path
        className="neon-blur"
        d="M20.12,48.78h0a1,1,0,0,1,0-2h0a1,1,0,1,1,0,2Z"
        form="late(2.17 -0.22)"
      />
      <path
        className="neon-blur"
        d="M20.12,42.47h0a1,1,0,0,1,0-2h0a1,1,0,1,1,0,2Z"
        form="late(2.17 -0.22)"
      />
      <path
        className="neon-blur"
        d="M49.28,48.63h-23a.85.85,0,1,1,0-1.7h23a.85.85,0,0,1,0,1.7Z"
        form="late(2.17 -0.22)"
      />
      <rect
        className="neon-blur"
    ...
    <g id="Warstwa_2_kopia_2" data-name="Warstwa 2 kopia 2">
      <path
        className="neon-line"
        d="M55.35,66.8H14.68l.62.63V4l-.62.62H55.35L54.73,4V67.43a.63.63,0,0,0,1.25,0V4a.64.64,0,0,0-.63-.63H14.68a.64.64,0,0,0-.63.63V67.43a.64.64,0,0,0,.63.62H55.35A.63.63,0,0,0,55.35,66.8Z"
        form="late(2.17 -0.22)"
      />
      <path
        className="neon-line"
        d="M57.89,6.89,67.31,9l-.43-.77q-5,23-10,46c-.17.78,1,1.12,1.2.33q5-23,10-46a.63.63,0,0,0-.43-.77l-9.42-2c-.79-.17-1.12,1-.34,1.2Z"
        form="late(2.17 -0.22)"
      />
      <path
        className="neon-line"
        d="M13.13,50.6l-11-40.53-.44.77,10.73-3a.63.63,0,0,0-.33-1.21l-10.73,3A.64.64,0,0,0,1,10.4q5.48,20.27,11,40.53a.62.62,0,0,0,1.2-.33Z"
        form="late(2.17 -0.22)"
      />
      <rect
        className="neon-line"
...
const Skills = () => (
  ...
  >
    ...
    <g id="Warstwa_4_kopia_2" data-name="Warstwa 4 kopia 2">
      <path
        className="neon-blur"
        d="M49.66,28c0,.29,0,.59-.06.89,0,.48.13-.58,0,.13-.1.46-.18.92-.31,1.37s-.21.7-.33,1.05-.31.72-.07.22c-.12.25-.23.49-.36.73A25.69,25.69,0,0,1,47,34.79c-.27.39-.54.79-.82,1.18,0,.08-.56.73-.26.36s-.36.41-.34.39c-1.19,1.37-2.79,2.49-3.61,4.15a10.31,10.31,0,0,0-1,3.76c0,.33,0,.65,0,1s-.2,2,0,.54A4.15,4.15,0,0,0,41.35,49a3.82,3.82,0,0,0,2.24,1.72c1.78.41,4.31-.54,4.61-2.62a16.32,16.32,0,0,0,.26-2.88c0-.71-.13.3,0-.07.06-.21.1-.43.16-.64s.11-.32.15-.48c.12-.47-.38.77-.07.23s-.51.47-.18.2a4.17,4.17,0,0,0,.36-.37c.3-.3.61-.58.91-.87a25.69,25.69,0,0,0,2.58-3A22,22,0,0,0,57.16,28a3.77,3.77,0,0,0-3.75-3.75A3.84,3.84,0,0,0,49.66,28Z"
        form="late(-12.34 -3.89)"
      />
      <path
        className="neon-blur"
        d="M28.4,47.18c-.06-2.18.07-4.36-1.06-6.31a21.1,21.1,0,0,0-3.13-3.67c-.26-.28-.52-.57-.79-.85l-.72-.79c-.42-.48.24.36-.13-.15a19.24,19.24,0,0,1-1.63-2.95c.4.83-.05-.16-.13-.38l-.21-.58a18,18,0,0,1-.53-2c0-.17-.22-1.56-.15-.8-.05-.52-.09-1-.1-1.55a14.82,14.82,0,0,1,.17-3,16.9,16.9,0,0,1,.39-1.71c.1-.38.22-.76.34-1.13.06-.18.12-.36.19-.54s.44-1,.08-.23a19.57,19.57,0,0,1,1.45-2.71c.11-.18.81-1.14.52-.77a15.69,15.69,0,0,1,1.34-1.48c.37-.37.76-.7,1.15-1,.66-.56-.49.33.06,0a22.72,22.72,0,0,1,2.6-1.57,15.25,15.25,0,0,1,3.78-1.24c.26-.06.53-.1.79-.15-.69.12.38,0,.43,0,.48,0,1-.06,1.44-.07a14.92,14.92,0,0,1,6.08,1.31c1.82.75,4.21-.82,4.62-2.62a3.86,3.86,0,0,0-2.62-4.61C33.07,1.47,21.52,5.37,16,14a23.49,23.49,0,0,0-.48,24.27A25,25,0,0,0,19.38,43a16.11,16.11,0,0,1,1.23,1.25c-.22-.28.17.26.17.26a4.91,4.91,0,0,1,.28.5c-.26-.68-.34-.86-.24-.53.21.64.11-.13,0-.22a5.39,5.39,0,0,1,0,1.06c0,.62,0,1.24,0,1.86a3.75,3.75,0,0,0,7.5,0Z"
        form="late(-12.34 -3.89)"
      />
      <path
        className="neon-blur"
        d="M44.82,43.4H24.59a3.75,3.75,0,1,0,0,7.5H44.82a3.75,3.75,0,0,0,0-7.5Z"
        form="late(-12.34 -3.89)"
      />
      <path
        className="neon-blur"
        d="M23.3,44.52a6.09,6.09,0,0,0-1.12,1.32,6.22,6.22,0,0,0-.73,1.57,2.13,2.13,0,0,0-.1.42,8.36,8.36,0,0,0-.17,1.32,5.86,5.86,0,0,0,.24,1.77,6.51,6.51,0,0,0,2.9,3.71,2.78,2.78,0,0,0,1.39.44,3.32,3.32,0,0,0,2.77-.73,2.91,2.91,0,0,0,1-1.06,3.79,3.79,0,0,0,.38-2.89,3.87,3.87,0,0,0-1.73-2.24L27.86,48l.75.59a3.08,3.08,0,0,1-.51-.51l.59.75a2.08,2.08,0,0,1-.32-.54l.37.9a2.88,2.88,0,0,1-.17-.64l.13,1a3.42,3.42,0,0,1,0-.64l-.13,1a2.66,2.66,0,0,1,.18-.67l-.38.9a3,3,0,0,1,.32-.55l-.59.76a3.38,3.38,0,0,1,.5-.5,4.14,4.14,0,0,0,1.1-2.65,4.14,4.14,0,0,0-1.1-2.66A3.75,3.75,0,0,0,26,43.43l-1,.13a3.8,3.8,0,0,0-1.66,1Z"
        form="late(-12.34 -3.89)"
      />
      <path
        className="neon-blur"
        d="M43,47.64H26.21a3.75,3.75,0,1,0,0,7.5H43a3.75,3.75,0,0,0,0-7.5Z"
        form="late(-12.34 -3.89)"
      />
      <path
        className="neon-blur"
        d="M24.3,48.74a6.12,6.12,0,0,0-1.13,1.31,6.56,6.56,0,0,0-.72,1.57,3,3,0,0,0-.11.43,9.56,9.56,0,0,0-.16,1.31,6,6,0,0,0,.24,1.78,6.48,6.48,0,0,0,2.9,3.7,2.7,2.7,0,0,0,1.39.45,2.84,2.84,0,0,0,1.5-.07,2.74,2.74,0,0,0,1.27-.67,2.8,2.8,0,0,0,1-1,3.8,3.8,0,0,0,.38-2.89,3.91,3.91,0,0,0-1.73-2.24l-.25-.17.76.59a3.58,3.58,0,0,1-.51-.52l.58.76a2.9,2.9,0,0,1-.31-.54l.37.9a2.88,2.88,0,0,1-.17-.64l.13,1a3.32,3.32,0,0,1,0-.63l-.13,1a2.55,2.55,0,0,1,.18-.67l-.38.89a3,3,0,0,1,.32-.54l-.59.76a3,3,0,0,1,.5-.51,2.78,2.78,0,0,0,.78-1.2,2.88,2.88,0,0,0,.32-1.45A2.85,2.85,0,0,0,30.38,50a2.75,2.75,0,0,0-.78-1.21A3.76,3.76,0,0,0,27,47.64l-1,.14a3.64,3.64,0,0,0-1.65,1Z"
        form="late(-12.34 -3.89)"
      />
      <path
        className="neon-blur"
        d="M41.21,51.86h-14a3.75,3.75,0,1,0,0,7.5h14a3.75,3.75,0,0,0,0-7.5Z"
        form="late(-12.34 -3.89)"
      />
    </g>
    ...
    <g id="Warstwa_4" data-name="Warstwa 4">
      <path
        className="neon-line"
        d="M52.79,28a18.43,18.43,0,0,1-5,10.93c-1,1.15-2.47,2.11-3.13,3.52s-.49,3-.71,4.53c-.12.79,1.09,1.13,1.2.33.22-1.51,0-3.22.78-4.59a8.92,8.92,0,0,1,1.58-1.67,22.53,22.53,0,0,0,2.09-2.38c2.42-3.21,4.18-6.6,4.4-10.67,0-.8-1.21-.8-1.25,0Z"
        form="late(-12.34 -3.89)"
      />
      <path
        className="neon-line"
        d="M25.27,47.18c0-1.58.19-3.32-.63-4.73a17.36,17.36,0,0,0-2.64-3,18.65,18.65,0,0,1-4.95-9.12c-1.61-7.94,2.16-16.47,9.48-20.12a18,18,0,0,1,14.93-.51c.75.31,1.07-.9.34-1.2a19.17,19.17,0,0,0-23.14,7.09,20.33,20.33,0,0,0-.48,21.11,21.42,21.42,0,0,0,3.41,4.13,7.78,7.78,0,0,1,2.24,2.86A13.4,13.4,0,0,1,24,47.18a.63.63,0,0,0,1.25,0Z"
        form="late(-12.34 -3.89)"
      />
      <path
        className="neon-line"
        d="M44.82,46.52H24.59a.63.63,0,0,0,0,1.25H44.82a.63.63,0,0,0,0-1.25Z"
        form="late(-12.34 -3.89)"
      />
      <path
        className="neon-line"
        d="M25.51,46.73a3.17,3.17,0,0,0-1.07,3.36,3.26,3.26,0,0,0,1.46,1.84.63.63,0,0,0,.63-1.08l-.17-.11c-.14-.09.09.08,0,0l-.17-.15L26,50.39l-.07-.09c.09.12,0,0,0,0a1.75,1.75,0,0,1-.16-.27s-.07-.14,0-.07,0-.1,0-.12a1.67,1.67,0,0,1-.08-.32c0-.18,0,.1,0-.09v-.35s0-.14,0,0a2.22,2.22,0,0,1,.09-.37l.06-.18c0,.08,0,0,0-.05a3,3,0,0,1,.18-.3c.09-.15-.06.06,0-.08l.13-.14a1.87,1.87,0,0,1,.3-.26.65.65,0,0,0,0-.89.66.66,0,0,0-.89,0Z"
        form="late(-12.34 -3.89)"
      />
      <path
        className="neon-line"
        d="M43,50.77H26.21a.63.63,0,0,0,0,1.25H43a.63.63,0,0,0,0-1.25Z"
        form="late(-12.34 -3.89)"
      />
      <path
        className="neon-line"
        d="M26.51,51a3.16,3.16,0,0,0-1.08,3.35,3.36,3.36,0,0,0,1.46,1.85.63.63,0,0,0,.64-1.08L27.36,55c-.14-.1.09.08,0,0l-.17-.15a1.37,1.37,0,0,1-.17-.17l-.07-.09c.09.11,0,0,0,0s-.11-.18-.16-.27-.07-.15,0-.08,0-.09,0-.11-.06-.22-.09-.33,0,.1,0-.08v-.35s0-.15,0-.06a2.49,2.49,0,0,1,.09-.37l.06-.17c0,.07,0,0,0-.06a2.38,2.38,0,0,1,.18-.3c.09-.15-.07.06,0-.07l.13-.15.29-.26a.62.62,0,0,0,0-.88.64.64,0,0,0-.88,0Z"
        form="late(-12.34 -3.89)"
      />
      <path
        className="neon-line"
        d="M41.21,55h-14a.63.63,0,0,0,0,1.25h14a.63.63,0,0,0,0-1.25Z"
        form="late(-12.34 -3.89)"
      />
    </g>
  </svg>
...
const CircleIcon = () => (
  ...
  >
    ...
    <g id="Warstwa_2_kopia" data-name="Warstwa 2 kopia">
      <path
        className="neon-line"
        d="M70.23,40A30.54,30.54,0,0,1,50.37,68.41a30.24,30.24,0,0,1-36.28-44A30.53,30.53,0,0,1,46,10.36a30.54,30.54,0,0,1,23.84,24.8A31.37,31.37,0,0,1,70.23,40a.63.63,0,0,0,1.25,0A31.8,31.8,0,0,0,50.86,10.45,31.49,31.49,0,0,0,13,56.22a31.49,31.49,0,0,0,58.1-11.39A33.93,33.93,0,0,0,71.48,40,.63.63,0,0,0,70.23,40Z"
        form="late(-5.39 -5.4)"
      />
    </g>
  </svg>
...
const CircleIcons = () => {
  return (
    <>
      ...
      <div className="i-col">
        <div className="circle-float delay">
          <div className="Link" to="/skills">
            <CircleSkills />
          </div>
        </div>
      </div>
