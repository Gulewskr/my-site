...
const Navbar = (props) => {
        ...
        <div role="navigation" >
                <div className='nav'>
                        ...
                        <NavbarLink a={props.s === "Umiejętności"} c={<Trans>skills</Trans>} nav="/my-site/skills" />
                        <NavbarLink a={props.s === "Projekty"} c={<Trans>proj</Trans>} nav="/my-site/projects" />
                        <NavbarLink a={props.s === "O mnie"} c={<Trans>about</Trans>} nav="/my-site/about" />
                        <NavbarLink a={props.s === "Kontakt"} c={<Trans>contact</Trans>} nav="/my-site/contact" />
                </div>
        </div>
        )
}
